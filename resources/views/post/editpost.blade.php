...
<div class="container">
    <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
            ...
            <form action="{{ url('update/post/'.$posts->id) }}" method="post" name="" id="" enctype="multipart/form-data" >
                @csrf
                ...
                <div class="control-group">
                    <div class="form-group floating-label-form-group controls">
                        ...
                        <textarea rows="5" name="details" class="form-control" placeholder="Message" id="message" >
                            {{ $posts->details}}
                        </textarea>
